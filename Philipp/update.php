...
<body>
  <fieldset>
    <legend class='h2'>Update request <img class='img-thumbnail rounded-circle'<?= "src='".(str_contains($picture, 'http') ? $data['image'] : "pictures/".$picture)."'" ?> alt="<?= $name ?>"></legend>
    <form action="actions/a_update.php" method="post" enctype="multipart/form-data">
      <table class="table">
        ...
        <tr>
          <input type="hidden" name="dish_id" value="<?php echo $data['dish_id'] ?>" />
